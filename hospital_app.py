...
with st.form("triage_form"):
    ...
    submitted = st.form_submit_button("Get AI Recommendation →")    #skibidi dop dop dop yes yes
    ...
    with res_col:
        ...
        <div style="background:{info['bg']};border:1.5px solid {info['border']};
            ...
            <div style="font-size:14px;color:#374151;margin-bottom:20px;">
                Our AI suggest you visit the <strong>{dept_name}</strong> Departement.
            </div>
        ...
        with prob_col:
            ...
            for idx, dname in sorted_depts:
                ...
                <div style="margin-bottom:14px;">
                     <div style="display:flex;justify-content:space-between;align-items:center;margin-botton:5px;">
